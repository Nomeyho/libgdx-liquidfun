...
public class Demo extends ApplicationAdapter implements InputProcessor {
    // Scaling between application's world and the box2D's world
	...
	private void createParticleStuff(float width, float height) {
        ...
        // (mParticleGroupDef1.position) and how much are created (parShape.setAsBox)
        // given the radius provided (systemDef.radius)
		...
		mParticleGroupDef2.color.set(0.2f, 0f, 0.3f, 1);
		mParticleSystem.createParticleGroup(mParticleGroupDef2);

        // The two groups have been created, but tje group definitions
        // are reused to spawn new particles on click events
        // see createParticles1() and createParticles2()
	...
	public void render() {
		...
		// Get the combined matrix and scale it down to our Box2D size
	...
	public void updateLog() {
		// Here we log the total particle count and the fps
